...
rcs_plot(cancer, x = "age", y = "status", time = "time", covs = "ph.karno", trans = "log10")

# logistic model with time not assigned
cancer$dead <- cancer$status == 2
rcs_plot(cancer, x = "age", y = "dead", covs = "ph.karno")

data=cancer; x = "age"; y = "wt.loss"; covs = "ph.karno"; time = NULL; knot = 4; add_hist = TRUE; ref = "x_median"; ref_digits = 3;
